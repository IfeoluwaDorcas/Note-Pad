...
import { ensureAndroidChannel, ensurePermissions } from '../notifications/setup';
  ...
  return (
    <PortalProvider>
      ...
      >
        ...
        <Drawer.Screen name="DeletedNotes"       options={{ title: 'Deleted Notes' }} />
        <Drawer.Screen name="DeletedReminders"   options={{ title: 'Deleted Reminders' }} />
        <Drawer.Screen name="DeletedStickyNotes" options={{ title: 'Deleted Sticky Notes' }} />
        <Drawer.Screen name="DeletedTodos"       options={{ title: 'Deleted To-dos' }} />
        <Drawer.Screen
          name="Editor"
          options={{
            title: 'Editor',
